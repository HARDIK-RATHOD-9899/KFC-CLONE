...
//   );
          ...
          <div className="firstDiv">
            <ul className="firstSubDiv">
              <li className='leftPartTopNav'>
                <Link to={"/"}><img src={kfc} className='logoImage' alt="" /></Link>
              ...
              <li className='rightPartTopNav'>
                <div className="StartButton" >
                  <Link to={"/menu"} style={{ color: "white", textDecoration: "none" }} >Start Order</Link></div>
                <div>
  
                  <Link to={"/api/Auth/login"}><img height={"30rem"} style={{ padding: "0.3vw 1vw" }} src={signin} alt="" 
                  /></Link>
  ...
  onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#c12c48'} 
  onMouseOut={(e) => e.currentTarget.style.backgroundColor = '#e4002b'} 
>
  Logout
</button>
